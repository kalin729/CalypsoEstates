...
public class PropertyService {
    ...
    public PropertyService(PropertyRepository propertyRepository, StatusRepository statusRepository, FileStorageService filesStorageService, ModelMapper modelMapper) {
